      ...
      <div className="bg-gray-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a href="/vehicles" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-medium transition duration-300">Pregled vozila</a>
            <a href="/reservations" className="bg-gray-700 hover:bg-gray-600 text-white px-6 py-3 rounded-lg font-medium transition duration-300">Rezerviraj termin</a>
          </div>
        </div>
      </div>
